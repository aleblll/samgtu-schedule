...
- [x] Надежное прямое скачивание отчетов старосты на устройство: статическая компоновка модуля `exportWord`, нативный мобильный Web Share API с сохранением в «Файлы/Загрузки», Capacitor и Blob-фоллбек без утечек в каналы и без сбоев WebAppMethodParamInvalid.
