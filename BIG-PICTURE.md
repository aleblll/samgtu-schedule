...
### Фаза 1: Оптимизация и Подготовка (Must Have — текущий спринт)
...
- [ ] Экспорт семестрового расписания в системные календари (iCal / `.ics` для iOS, Android, Google Calendar).
