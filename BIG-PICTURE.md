...
- [x] Редизайн светлой темы: уход от ослепляющего белого к мягкому фону (`slate-50`), объемным карточкам (`bg-white`, `border-slate-200/80`) и контрастной типографике.
- [x] Прямое скачивание отчетов старосты на устройство: удаление автопостинга в Telegram-канал и редиректа, нативное сохранение через `Telegram.WebApp.downloadFile` / Blob / Capacitor.
