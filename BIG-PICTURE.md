...
- [x] Редизайн светлой темы: мягкий сланцевый холст (`slate-100` / `#f1f5f9`), объемные белые карточки (`bg-white`, `border-slate-200/90`, `shadow-xs`), синхронизация фона Telegram WebApp и четкая контрастная типографика.
